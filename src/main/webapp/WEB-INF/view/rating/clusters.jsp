                    ...
                    <div id="content">
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                          ...
                          <!-- Start Gold Cluster -->
                          <c:forEach var="entry" items="${employeesByCluster}" varStatus="loop">
                            <div class="card-body">
                                  ...
                                  <c:choose>
                                    <c:when test="${loop.index eq 0}">
                                      <tbody style="background-color: gold;">
                                        <c:forEach var="employee" items="${entry.value}">
                                          <tr>
                                            <td>
                                      ...
                                      <tbody style="background-color: silver;">
                                        <c:forEach var="employee" items="${entry.value}">
                                          <tr>
                                            ...
                                            <td>Silver Cluster</td>
                                          </tr>
                                        </c:forEach>
                                      </tbody>
                                    </c:when>
                                    <c:when test="${loop.index eq 2}">
                                      <tbody style="background-color: brown;">
                                        <c:forEach var="employee" items="${entry.value}">
                                          <tr>
                                            <td>
                                              <c:out value="${employee.firstName}" />
