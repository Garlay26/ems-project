                    ...
                    <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
                        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                            ...
                            <head>
                                ...
                                <title>Employee Admin - Give Rating</title>
                                    ...
                                    <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        <div id="content">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <!-- Page Heading -->
                                                <h1 class="h3 mb-2 text-gray-800">Give Rating</h1>
                                                <br>

                                                <form class="was-validated" action="addRating" method="POST">
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationTooltip01">Employee Name</label>
                                                            <select class="custom-select" id="employee_id"
                                                        ...
                                                        <div class="col-md-4 mb-3 mt-4">
                                                            <label for="validationTooltip03">Rating Score (1 -
                                                                100)</label>
                                                            <input type="number" class="form-control" id="rating"
                                                                name="rating" placeholder="Rating Score" required>
                                                        </div>
                                                    </div>
                                                    <button class="btn btn-primary mt-4 mb-4" type="submit">Give
                                                        Rating
                                                    </button>
